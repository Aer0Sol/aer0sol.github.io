...
**We are using a Merkle–Damgård hash function (SHA256 here) which is vulnerable to [Hash Length Extension Attack](https://en.wikipedia.org/wiki/Length_extension_attack), can we do something possibly with it?**
